...
## Expected result
- Spec: Yêu cầu thất bại, hệ thống chặn việc thêm với số lượng trống.
- *Lưu ý (SUT Bug):* Trên ứng dụng thực tế, hệ thống vẫn báo "Thành công - Đã thêm vào giỏ hàng" và tự động thêm số lượng bằng 1 vào giỏ do `parseInt` trả về `NaN`, kích hoạt fallback về 1.
