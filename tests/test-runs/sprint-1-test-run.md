...
| TC-COUPON-001     | Coupons        | Nguyễn Đặng Đức Thịnh | Fail   | [#1](https://github.com/dev-thinh/HW02/issues/1)                                                   | Lỗi tính sai giá trị percent giảm giá        |
...
| TC-COUPON-011     | Coupons        | Nguyễn Đặng Đức Thịnh | Fail   | [#1](https://github.com/dev-thinh/HW02/issues/1)                                                   | Percent giảm giá bị nhân ngược lên           |
...
| TC-COUPON-BVA-002 | Coupons        | Nguyễn Đặng Đức Thịnh | Fail   | [#2](https://github.com/dev-thinh/HW02/issues/2)                                                   | order_total = 300,000 ₫ (Bị từ chối sai)     |
...
| TC-COUPON-BVA-005 | Coupons        | Nguyễn Đặng Đức Thịnh | Fail   | [#2](https://github.com/dev-thinh/HW02/issues/2)                                                   | order_total = 500,000 ₫ (Bị từ chối sai)     |
...
| TC-COUPON-BVA-008 | Coupons        | Nguyễn Đặng Đức Thịnh | Fail   | [#2](https://github.com/dev-thinh/HW02/issues/2)                                                   | order_total = 300,000 ₫ VIP100 (Từ chối sai) |
...
| TC-CAT-002        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#3](https://github.com/dev-thinh/HW02/issues/3)                                                   | Cho phép tạo danh mục trùng tên              |
| TC-CAT-003        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#4](https://github.com/dev-thinh/HW02/issues/4)                                                   | Cho phép tạo danh mục tên rỗng               |
| TC-CAT-004        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#4](https://github.com/dev-thinh/HW02/issues/4)                                                   | Cho phép tạo danh mục tên khoảng trắng       |
| TC-CAT-005        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#5](https://github.com/dev-thinh/HW02/issues/5)                                                   | Normal user tạo danh mục thành công          |
...
| TC-CAT-008        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#6](https://github.com/dev-thinh/HW02/issues/6)                                                   | Normal user xóa danh mục thành công          |
...
| TC-CAT-012        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#7](https://github.com/dev-thinh/HW02/issues/7)                                                   | API xóa ID âm trả về 200 OK                  |
| TC-CAT-013        | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#8](https://github.com/dev-thinh/HW02/issues/8)                                                   | API xóa ID chữ trả về 200 OK                 |
| TC-CAT-SEC-001    | Category       | Nguyễn Đặng Đức Thịnh | Pass   | None                                                                                               | XSS script text được render an toàn          |
| TC-CAT-BVA-001    | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#4](https://github.com/dev-thinh/HW02/issues/4)                                                   | Cho phép tạo tên dài 0 ký tự                 |
...
| TC-CAT-BVA-004    | Category       | Nguyễn Đặng Đức Thịnh | Fail   | [#7](https://github.com/dev-thinh/HW02/issues/7), [#8](https://github.com/dev-thinh/HW02/issues/8) | Cho phép xóa ID bằng 0                       |
...
| TC-MPROD-003      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#9](https://github.com/dev-thinh/HW02/issues/9)                                                   | Thêm thành công khi số lượng = 0             |
| TC-MPROD-004      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#10](https://github.com/dev-thinh/HW02/issues/10)                                                 | Thêm thành công khi số lượng âm (-3)         |
| TC-MPROD-005      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#11](https://github.com/dev-thinh/HW02/issues/11)                                                 | Tự động làm tròn số lượng thập phân (1.5)    |
| TC-MPROD-006      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#12](https://github.com/dev-thinh/HW02/issues/12)                                                 | Tự động add 1 khi số lượng rỗng              |
| TC-MPROD-007      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#13](https://github.com/dev-thinh/HW02/issues/13)                                                 | Tự động add 2 khi nhập "2a"                  |
| TC-MPROD-008      | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#14](https://github.com/dev-thinh/HW02/issues/14)                                                 | Tự động add 1 khi nhập chữ "abc"             |
...
| TC-MPROD-BVA-001  | Mobile-Product | Nguyễn Đặng Đức Thịnh | Fail   | [#9](https://github.com/dev-thinh/HW02/issues/9)                                                   | Số lượng = 0 (MIN-1) được add vào giỏ        |
